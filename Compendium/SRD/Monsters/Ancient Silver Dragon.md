  ...
  - name: Breath Weapons (Recharge 5-6)
    entries:
      - |-
        ...
        **Cold Breath.** The dragon exhales an icy blast in a 90-foot cone. Each creature in that area must make a `dc:CON` Constitution saving throw, taking `damage:15d8` cold damage on a failed save, or half as much damage on a successful one.
