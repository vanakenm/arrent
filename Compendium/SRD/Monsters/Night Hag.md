...
traits:
  - name: Innate Spellcasting
    entries:
      - |-
        The hag's innate spellcasting ability is Charisma (spell save `dc:CHA`, `atk:CHA` with spell attacks). She can innately cast the following spells, requiring no material components:
