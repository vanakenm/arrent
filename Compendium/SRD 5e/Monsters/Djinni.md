...
actions:
  ...
  - name: Scimitar
    entries:
      - 'Melee Weapon Attack: `atk:STR+PB`, reach 5 ft., one target. Hit: `dmg:2d6+STR` slashing damage plus 3 (`dice:1d6`) lightning or thunder damage (djinni''s choice).'
    attacks:
...
traits:
  ...
  - name: Innate Spellcasting
    entries:
      - |-
        The djinni's innate spellcasting ability is Charisma (spell save `dc:CHA`, `atk:+9` with spell attacks). It can innately cast the following spells, requiring no material components:
