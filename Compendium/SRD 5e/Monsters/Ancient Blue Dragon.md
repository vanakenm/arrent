...
archivist: true
entity_type: monster
slug: srd-5e_monster_ancient-blue-dragon
...
actions:
  ...
  - name: Bite
    entries:
      - 'Melee Weapon Attack: `atk:STR+PB`, reach 15 ft., one target. Hit: `dmg:2d10+STR` piercing damage plus `dmg:2d10` lightning damage.'
    attacks:
      - name: Bite attack
        type: melee
        bonus: 16
  ...
  - name: Lightning Breath
    entries:
      - The dragon exhales lightning in a 120-foot line that is 10 feet wide. Each creature in that line must make a `dc:23` Dexterity saving throw, taking `dmg:16d10` lightning damage on a failed save, or half as much damage on a successful one.
    recharge:
