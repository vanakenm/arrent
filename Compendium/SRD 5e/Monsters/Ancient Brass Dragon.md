...
archivist: true
entity_type: monster
slug: srd-5e_monster_ancient-brass-dragon
  ...
  - name: Breath Weapons
    entries:
      - |-
        ...
        - **Fire Breath.** The dragon exhales fire in an 90-foot line that is 10 feet wide. Each creature in that line must make a `dc:21` Dexterity saving throw, taking `dmg:16d6` fire damage on a failed save, or half as much damage on a successful one.
